// Generated from target/idl/shillbot.json; do not edit.
export default {
  "address": "2tR37nqMpwdV4DVUHjzUmL1rH2DtkA8zrRA4EAhT7KMi",
  "metadata": {
    "name": "shillbot",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Shillbot task marketplace — escrow, verification, and payment"
  },
  "instructions": [
    {
      "name": "approve_task",
        ...
        },
        {
          ...
          "pda": {
            "seeds": [
              ...
              {
                "kind": "account",
                "path": "session_delegate.agent",
                "account": "SessionDelegate"
              }
            ]
          }
        },
    ...
    },
    {
      ...
      "args": [
        ...
        {
          "name": "attestation_delay_override",
          "type": "u32"
        },
        {
          "name": "challenge_window_override",
          "type": "u32"
        },
        {
          "name": "verification_timeout_override",
          "type": "u32"
        },
        {
    ...
    {
      "name": "resolve_challenge_default",
      "docs": [
      ...
      "accounts": [
        {
          ...
          "pda": {
            "seeds": [
              ...
              {
                "kind": "account",
                "path": "session_delegate.delegate",
                "account": "SessionDelegate"
              }
            ]
          }
    ...
    },
    {
      ...
      "args": [
        ...
        {
          "name": "attestation_delay_seconds",
          "type": "i64"
        },
        {
          "name": "staleness_window_seconds",
          "type": "i64"
        },
        {
        ...
        {
          "name": "challenge_bond_multiplier",
          "type": "u8"
        },
        {
          "name": "bond_slash_treasury_bps",
          "type": "u16"
        },
        {
          "name": "paused",
        ...
        {
          "name": "max_tasks_per_rate_window",
          "type": "u32"
        },
        {
          "name": "dispute_resolution_window_seconds",
          "type": "i64"
        }
      ]
    },
  ...
  "errors": [
    ...
    {
      "code": 6028,
      "name": "TimingOverrideOutOfBounds",
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "challenge_bond_multiplier_bps",
            "docs": [
