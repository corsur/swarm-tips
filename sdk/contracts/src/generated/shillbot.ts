 ...
 * IDL can be found at `target/idl/shillbot.json`.
 */
export type Shillbot = {
  ...
  "instructions": [
    ...
    },
    {
      ...
      "args": [
        ...
        {
          "name": "attestationDelayOverride",
          "type": "u32"
        },
        {
          "name": "challengeWindowOverride",
          "type": "u32"
        },
        {
          "name": "verificationTimeoutOverride",
          "type": "u32"
        },
        {
    ...
    },
    {
      ...
      "args": [
        ...
        {
          "name": "verificationTimeoutSeconds",
          "type": "i64"
        },
        {
          "name": "attestationDelaySeconds",
          "type": "i64"
        },
        {
          "name": "stalenessWindowSeconds",
          "type": "i64"
        },
        {
          "name": "maxConcurrentClaims",
          "type": "u8"
        },
        {
          "name": "challengeBondMultiplier",
          "type": "u8"
        },
        {
          "name": "bondSlashTreasuryBps",
          "type": "u16"
        },
        {
          "name": "paused",
        ...
        {
          "name": "maxTasksPerRateWindow",
          "type": "u32"
        },
        {
          "name": "disputeResolutionWindowSeconds",
          "type": "i64"
        }
      ]
    },
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "challengeBondMultiplierBps",
            "docs": [
