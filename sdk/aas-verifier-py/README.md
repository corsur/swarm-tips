...
```sh
pip install aas-verifier
```

## Use

```python
from aas_verifier import verify_v1, SHILLBOT_PROTOCOL
from aas_verifier.cli import make_solana_rpc_fetcher
...
Implements all 7 steps of `docs/specs/aas-v1.md` §4 with the closed
