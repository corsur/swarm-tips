...
- 2026-06-30: Moltlaunch → **Removed**. `api.moltlaunch.com` decommissioned (DNS gone), no replacement endpoint. Re-add per the listing policy above if a working gigs API returns.
